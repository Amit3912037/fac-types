      ...
      <div className="mx-auto px-4">
        <div className="flex justify-between">
          ...
          <div className="hidden md:flex items-center space-x-1">
            <a href="" className="py-4 px-2 text-white font-semibold">
              Login
            </a>
            <a href="" className="py-4 px-2 text-white font-semibold">
              Orders
      ...
      <div className={`${mobileView ? "" : "hidden"} mobile-menu`}>
        <ul className="">
          ...
          <li>
            <a
              href="index.html"
              className="block text-white text-sm px-6 py-4 font-semibold"
            >
              Login
            </a>
          </li>
          <li>
            <a href="#" className="block text-white text-sm px-6 py-4">
              Orders
            </a>
          </li>
          <li>
